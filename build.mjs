...
html=html.replace('<title>Eaglercraft 1.12.2</title>','<title>Shinobi SMP — Play</title>')
 .replace(/<meta property="og:description"[^>]*>/,'<meta property="og:description" content="Shinobi SMP friends survival">')
 .replace('worldsDB: "worlds"',`worldsDB: "shinobi_worlds",\n            lang: "en_US",\n            allowVoiceClient: false,\n            servers: [{addr:(location.protocol === "https:" ? "wss://" : "ws://") + location.host + "/multiplayer",name:"Shinobi SMP"}]`);
